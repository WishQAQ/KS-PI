ALTER  TABLE  `user_orders` modify column product_id VARCHAR(255) comment '订单关联产品或活动唯一id';
ALTER  TABLE  `user_orders` modify column logistics_no varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物流编号';
ALTER  TABLE  `user_orders` modify column status tinyint(1) NULL DEFAULT NULL COMMENT '状态 1未付款 2已付款 3已发货 4已收货 5删除';
ALTER  TABLE  `user_orders` add type tinyint(1) not null default 0 comment '类型：1产品唯一id 2活动唯一Id';
ALTER  TABLE  `user_orders` add created_id varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '买家全局uid',
