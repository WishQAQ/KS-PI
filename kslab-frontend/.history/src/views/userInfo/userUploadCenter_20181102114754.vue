            ...
            <div class="userUpload_box">
              ...
              <div class="userUpload_box_list" v-for="(item,index) in videoList" :key="index">
                ...
                <div class="userUpload_operating">
                  <div class="userUpload_operating_modify" v-if="item.status != 2" @click="jumpVidPage(index)"><i class="icon icon-bi"></div>
          ...
          <el-tab-pane label="我的百科" name="Encyclopedia">
            ...
            <div class="userUpload_box userEncyclopedia" v-if="1 == indexLength">
              ...
              <div class="userUpload_box_list" v-for="(encyclopediaList ,index) in encyclopediaDate" :key="index">
                ...
                <div class="userUpload_operating">
                  <div class="userUpload_operating_modify" v-if="encyclopediaList.status == 2" @click="jumpEncPage(index)"><i class="icon icon-bi"></div>
          ...
          <el-tab-pane label="我的问题" name="problem">
            ...
            <div class="userUpload_box userProblem" v-if="2 == indexLength">
              ...
              <div class="userUpload_box_list" v-for="(item,index) in questionList" :key="index">
                ...
                <div class="userUpload_operating">
                  <div class="userUpload_operating_modify" v-if="item.status !== 2" @click="jumpQusPage(index)"><i class="icon icon-bi"></div>
          ...
          <el-tab-pane label="我的回答" name="reply">
            ...
            <div class="userUpload_box userReply" v-if="3 == indexLength">
              ...
              <div class="userUpload_box_list" v-for="(item,index) in answerList" :key="index">
                ...
                <div class="userUpload_operating">
                  <div class="userUpload_operating_modify" v-if="item.status !== 2" @click="jumpAnsPage(index)"><i class="icon icon-bi"></div>
                  <div class="userUpload_operating_delete" @click="ansDelet(index)"></div>
          ...
          <el-tab-pane label="我的文章" name="article">
            ...
            <div class="userUpload_box userArticle" v-if="4 == indexLength">
              ...
              <div @click="JumpArticle(index)" class="userUpload_box_list" v-for="(item,index) in articleList" :key="index">
                ...
                <div class="userUpload_operating">
                  <div class="userUpload_operating_modify" v-if="item.status !== 2" @click="jumpArtlePage(index)"><i class="icon icon-bi"></div>
    ...
    methods: {
      ...
      handleClick(tab, event) {
        ...
        if(tab.index == 0){
          ...
          console.log("3")
          //获取我的回答
          this.$ajax.post(this.request.axiosPort+this.request.axiosApi+'my/answer/list',{
              token:window.localStorage.token,
              page_size:8,
              page:1
          })
