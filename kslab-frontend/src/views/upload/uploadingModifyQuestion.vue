        ...
        <section id="editor">
            ...
            <div class="mod_uploading">
                <div class="mod_uploading_main">
                    ...
                    <uploadingEncycMainFile id="uploading_main_file" :attachments="this.dataAtomUirl.attachment" v-on:getFile="getFile" :qsID="qsID" :infoData="infoData"></uploadingEncycMainFile>
    ...
    export default {
        ...
        methods:{
            ...
            getData(){               
                ...
                this.infoData = routerQuery
                if(typeof(this.dynamicTags)==='string'){
                    this.dynamicTags=this.dynamicTags.split(',')
                }
            ...
            getFile(file){
                console.log(file);
                if(file){
                    this.serial_number=this.question_id
                }
                this.fileData = file;
            }
        }    
