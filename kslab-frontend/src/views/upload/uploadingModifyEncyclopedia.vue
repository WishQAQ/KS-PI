                        ...
                        <el-tab-pane label="编辑百科" name="3">
                            ...
                            <div class="uploading_compile_encyclopedia">
                                ...
                                <div class="compile_encyclopedia_detail">
                                    ...
                                    <uploadingEncycMainFile id="uploading_main_file" :attachments="this.dataAtomUirl.attachment" v-on:getFile="getFile" :bkID="this.bkID" :infoData="this.infoData"></uploadingEncycMainFile>
    ...
    export default {
        ...
        methods:{
            ...
            getData(){
                    ...
                    this.bkID = routerQuery.encyclopedia_id        //关键词
                    //获取百科ID
                    var id = routerQuery.encyclopedia_id;
                    console.log('我要取得百科ID'+id)
                    this.Id  = id;
                    ...
                    .then((res) => {
                        ...
                        if(res.data.data.source == null){
                            ...
                            this.partList = res.data.data.source;
                        }
                        console.log(this.partList);
