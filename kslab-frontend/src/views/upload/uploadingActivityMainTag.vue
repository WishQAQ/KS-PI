  ...
  export default {
    ...
    methods: {
      handleClose(tag) {
        ...
        this.$store.dispatch('getActivityUploadData', activityData).then(res => {
          //console.log(this.$store.state.AcitivityUpload.AcitivityUploadData)
        });
    ...
    watch: {
      ...
      tags(){
          if(this.tags){
              this.dynamicTags=[];
              console.log(this.$store.state.activityUpload.activityUploadData.tags);
              this.$store.state.activityUpload.activityUploadData.tags.forEach(item=>{
