    ...
    >
      ...
      <el-tab-pane
        ...
        <div slot="label" class="ksChat_user ksChat_merchant">
          <el-badge :value="item.unread_num" :max="99" class="item ksChatNbm" :hidden="badge===true?true:item.unread_num===0">
...
<script>
  import KsChatBoxDiv from '../ksChat/ksChatBox'
...
<style lang="less">
  .ksChat {
    ...
    /*未读信息样式*/
    .ksChatNbm .el-badge__content.is-fixed {
      right: 20px !important;
    }
    .ksChatNbm .el-badge__content {
      width: 18px;
      border: none !important;
      justify-content: center;
      align-items: center;
