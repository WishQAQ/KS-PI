...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tObject = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   <object type="{type}" width="{width}" height="{height}">\n' +
        ...
        defaultPreviewSettings = {
            image: {width: "85px", height: "50px"},
            html: {width: "213px", height: "50px"},
            text: {width: "auto", height: "80px"},
            video: {width: "auto", height: "45px"},
            audio: {width: "213px", height: "80px"},
            flash: {width: "213px", height: "160px"},
            object: {width: "auto", height: "50px"},
            other: {width: "auto", height: "50px"}
        },
