...
/*----Longimg为原图片链接，img为新，class元素class/id----*/
	...
	HoverImg(".HoverQQ a img","static/img/icon/QQ_block.png","static/img/icon/QQ2c.png")
	HoverImg(".HoverWeibo a img","static/img/icon/weibo_block.png","static/img/icon/weibo1.png")
	HoverImg(".Hoverwechar a img","static/img/icon/wechar_block.png","static/img/icon/wechar.png")
//
//
// /*-------对电子邮件/手机的验证-------*/
//
...
/*-----百度选择项------*/
  ...
  //     			  	imageAllowFiles:['.png','.jpg','jpeg','png','bmp'],
