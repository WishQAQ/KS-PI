...
inCity.cssParents = function(){ //城市显示
    ...
    console.log(inCity.left);
    $(inCity.id).css({"top":inCity.top+"px","left":0+"px","width":inCity.width+"px","height":inCity.height+"px"});
}
...
inCity.cityClick = function ($this) {
    $(".city_a_le1 a").click(function () {
       ...
       {
        $(".title_Location").css("width","130px")
       }
       else if(ContName.length == 3)
       {
        $(".title_Location").css("width","120px")
       }
       else{
        $(".title_Location").css("width","110px")
       }
        $(".Location_name").html(ContName)
        return false;
    })
}
