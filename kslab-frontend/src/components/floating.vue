<template>
  <div class="">
    <div class="floatingBox">
      <div @click="handleOpenChat"><i class="icon icon-ziyuan3"></i></div>
      <div class="shoppingCart" style="display:none"><router-link to="/home/shopping-cart"><i class="icon icon-ziyuan34"></i></router-link></div>
