    ...
    <div class="content">
      ...
      <div class="tabs">
          ...
          :row-style="{height:'40px'}" :cell-style="{padding:0}" style="width: 100%">
              ...
              <el-table-column prop="description" label="介绍" min-width="200"></el-table-column>
    ...
    <el-dialog :visible.sync="editVisible" width="400px">
      ...
      <div class="jurisdiction_content">
        <div class="jurisdiction_content_item">
          ...
          <el-input class="el_input" size="mini" v-model="industryTitle"></el-input>
        </div>
        <div class="jurisdiction_content_item">
...
<script>
  ...
  export default {
    ...
    mounted(){
        // this.$axios.post('http://test.kslab.com/api/admin/menu/create', 
        //     {
        //         token:this.token,
    ...
    methods: {
      ...
      addDepartment(){
        if(this.industryTitle && this.industryContent){
            if(this.isUpdate){
                this.HttpClient.post('/admin/department/edit',{id:this.id,name:this.industryTitle,description:this.industryContent})
                    .then(res=>{
                        console.log(res);
                ...
                this.HttpClient.post('/admin/department/create',{name:this.industryTitle,description:this.industryContent})
                    .then(res=>{
                        console.log(res);
