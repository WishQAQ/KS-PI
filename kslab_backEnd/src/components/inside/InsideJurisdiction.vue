<template>
    <div>
        ...
        <div class="tabs">
          <el-table :data="slist" border :stripe="true" :header-row-style="{height:'40px'}"
           :header-cell-style="{padding:0,background:'#15bafe',color:'white'}" :row-style="{height:'40px'}" :cell-style="{padding:0}" style="width: 100%">
            ...
            <el-table-column prop="label"  label="权限名称" width="200">
            ...
            <el-table-column label="类型(选择)" width="100">
                <template slot-scope="scope">
                    {{scope.row.type===0?'未分配':'已分配菜单'}}
                </template>
            </el-table-column>
            <el-table-column prop="name" label="模块和方法" width="210"></el-table-column>
            <el-table-column prop="plate" label="板块" width="150"></el-table-column>
            <el-table-column prop="menu_1" label="一级菜单" width="150"></el-table-column>
            <el-table-column prop="menu_2" label="二级菜单" width="150"></el-table-column>
      ...
      <el-dialog :visible.sync="amendVisible" width="400px">
        <div slot="title" class="dialog_head_title">
          <i class="iconfont icon-edit-square examine_icon"></i>
          <span>修改权限</span>
        </div>
