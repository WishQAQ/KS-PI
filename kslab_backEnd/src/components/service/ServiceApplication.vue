        ...
        <div class="service_content">
          ...
          <el-table
            ...
            <el-table-column
              ...
              width="130">
              <template slot-scope="scope">
                <p><i class="iconfont icon-dian"></i>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div class="service_btm">
                  ...
                  <div @click="rejectButton(scope.row.service_id)">查看反馈</div>
                  <div>预览服务</div>
                  <div style="color: #15bafe" v-if="scope.row.status===3" @click="examineButton(scope.row.service_id)">提交审核</div>
                  <div style="color: #fff;background: red" @click="deleteButton(scope.row.service_id)">删除</div>
        ...
        <div class="basicInfoDialog_main">
          ...
          <div class="upload">
            ...
            <div class="annex">
              ...
              <div class="el-upload__text" v-for="item in basicData.admin_upload_images" :key="item.uid" @click="checkImages(item.url)">{{item.name}}</div>
