<template>
  <div class="articleComment">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <!--<template slot="header" slot-scope="scope">-->
                <!--<div class="statisticsTable_header">-->
                  <!--<span><i class="iconfont icon-star"></i>评论总数</span>-->
                  <!--<p>15005</p>-->
                <!--</div>-->
              <!--</template>-->
              <el-table-column
          ...
          <form>
            <div class="content_header">
              ...
              <div class="content_header_search">
                <el-input placeholder="文章名称" clearable v-model="articleTitle" @keyup.13.native="getCommentList" @clear="getCommentList">
                  <el-button slot="append" icon="el-icon-search" @click="getCommentList"></el-button>
                </el-input>
                <el-input placeholder="昵称搜索" clearable v-model="nickname" @keyup.13.native="getCommentList" @clear="getCommentList">
                  <el-button slot="append" icon="el-icon-search" @click="getCommentList"></el-button>
                </el-input>
              </div>
            </div>
            ...
            <div class="content_table">
              ...
              <el-table
                ...
                <el-table-column
                  ...
                  label="操作">
                  <template slot-scope="scope">
                    <div @click="rejectButton(scope.row.answer_id)">禁用</div>
                    <div @click="deleteButton(scope.row.answer_id)">删除</div>
                    <div @click="previewButton(scope.row.id)">预览</div>
                    <div @click="recoverButton(scope.row.answer_id)">恢复</div>
                  </template>
                </el-table-column>
              </el-table>
                <el-pagination
    ...
    <el-dialog
      ...
      <span slot="title" class="previewDialog_title"><i class="iconfont icon-chakan"></i>评论预览</span>
