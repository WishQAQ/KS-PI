    ...
    <div>
      ...
      <div class="content">
        ...
        <div class="content_contain">
          <div class="conditions">
            <el-select size="mini" class="select_normal" clearable @change="plateChange" v-model="plateValue" placeholder="板块">
              <el-option
            ...
            <el-select size="mini" class="select_normal" clearable @change="getApplyList" v-model="levelValue" placeholder="二级" v-if="plateValue!==''">
              <el-option
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  ...
                  <el-button size="small" type="text" @click="rejectButton">查看反馈</el-button>
                  ...
                  <el-button
                    size="small"
                    type="text"
                    v-if="isShowDelete(scope.row.created_at) && scope.row.status===3"
                    @click="deleteButton(scope.row.active_id)">
                      删除
                  </el-button>
      ...
      <el-dialog :visible.sync="merchantDialog" width="400px">
            ...
            <div class="check_merchant">
                ...
                <p class="merchant_license">执照号:{{merchantData.license}}</p>
                <p class="merchant_legal_person">{{merchantData.legal_person}}</p>
                <p class="merchant_legal_id">法人代表:{{merchantData.legal_idcard}}</p>
                <p class="merchant_register_address">法人身份证:{{merchantData.address_register}}</p>
                <p class="merchant_practical_address">注册地址:{{merchantData.address_manage}}</p>
                <p class="merchant_duty_paragraph">经营地址:{{merchantData.duty}}</p>
        ...
        <el-dialog :visible.sync="rejectVisible" width="360px">
            ...
            <div class="user_footer" slot="footer">
                <el-row class="row_e">
                    <el-button type="primary" size="small"  class="btn_delete" @click="rejectVisible = false">关闭</el-button>
                </el-row>
            </div>
        </el-dialog>
        <!--删除框-->
