      ...
      <div class="content">
        ...
        <div class="content_contain">
            <div class="conditions">
                <div class="activityname">{{headData.title}}</div>
                <div>玩出酷耍生命力，挑战720度回转寿司</div>
                <div>{{headData.city_name}}</div>
            </div>
        <div class="tables">
            <el-table
              :data="tableData"
              ...
              <el-table-column
                ...
                width="120">
                <template slot-scope="scope">
                    <span v-if="scope.row.quantity = scope.row.use_num = 0">已使用</span>
                    <span v-if="scope.row.quantity > scope.row.use_num">未用完</span>
                    <span v-if="scope.row.use_num = 0">未使用</span>
                </template>
              </el-table-column>
              <el-table-column
                label="操作"
                ...
                <template slot-scope="scope">
                  ...
                  <el-button size="small" type="text" @click="handleInspectTicket(scope.row.order_id)">验票</el-button>
